...
- [O que é a API do parceiro de vendas?](#what-is-the-selling-partner-api)

  - [Funções chave](#key-features)

  - [Aplicações globais](#global-applications)

- [Endpoints da API do parceiro de vendas](#selling-partner-api-endpoints)

- [valores marketplaceId](#marketplaceid-values)

- [Registrar-se como um desenvolvedor](#registering-as-a-developer)

  - [Verificar o status da sua solicitação para registrar-se como um desenvolvedor](#checking-the-status-of-your-request-to-register-as-a-developer)

- [Criar e configurar políticas e entidades de IAM](#creating-and-configuring-iam-policies-and-entities)
  - [Etapa 1. Criar uma conta AWS](#step-1-create-an-aws-account)
  
  - [Etapa 2. Criar um usuário IAM](#step-2-create-an-iam-user)
  
  - [Etapa 3. Criar uma política IAM](#step-3-create-an-iam-policy)
  
  - [Etapa 4. Criar uma função de IAM](#step-4-create-an-iam-role)
  
  - [Etapa 5. Adicionar uma política de Serviço de Token de Segurança AWS para seu usuário IAM](#step-5-add-an-aws-security-token-service-policy-to-your-iam-user)
  
- [Registrar sua aplicação](#registering-your-application)
  
- [Ver as informações e credenciais de sua aplicação](#viewing-your-application-information-and-credentials)

- [Autorizar aplicações do Parceiro de vendas](#authorizing-selling-partner-api-applications)

  - [Como minha aplicação é autorizada?](#how-is-my-application-authorized)

  - [Construindo uma URI para autorização OAuth](#constructing-an-oauth-authorization-uri)
